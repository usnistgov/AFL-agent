...
class DiffractionLabelerView:
    ...
    def run(self,x,y,all_compositions,composition,models,possible_phase_labels):
        ...
        self.b0 = ipywidgets.Button(description='A')
        self.b1 = ipywidgets.Button(description='B')
        self.b2 = ipywidgets.Button(description='C')
        self.b3 = ipywidgets.Button(description='D')
        self.b4 = ipywidgets.Button(description='E')
        ...
        buttons_hbox1 = ipywidgets.HBox([self.b0,self.b1,self.b2,self.b3,self.b4,self.br])
