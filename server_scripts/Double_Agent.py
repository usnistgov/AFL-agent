...
from AFL.double_agent.AgentDriver import DoubleAgentDriver
...
server = APIServer('Double_Agent',index_template="index.html",data=data)
server.add_standard_routes()
server.create_queue(DoubleAgentDriver())
server.init_logging()
